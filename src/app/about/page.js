      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white">
        ...
        <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative text-center max-w-3xl mx-auto px-4">
            <h1 className="font-playfair text-4xl md:text-5xl font-bold mb-6">About Us</h1>
            <p className="text-lg md:text-xl text-[#aaa] leading-relaxed text-justify lg:text-center">
        ...
        <section className="py-20 from-[#141412] via-transparent to-transparent">
          <div className="max-w-8xl">
              <div className="text-center mb-52">
                <h2 className="font-playfair text-[#C9A96E] text-3xl md:text-4xl font-bold mb-6">Our Story</h2>
                <p className="text-[#aaa] max-w-3xl mx-auto leading-relaxed text-justify lg:text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              {features.map((feature, index) => (
                <div key={index} className="text-center">
                  <h3 className="text-xl md:text-2xl font-semibold text-[#C9A96E] mb-4">{feature.title}</h3>
                  <p className="text-[#aaa] leading-relaxed">{feature.description}</p>
                </div>
              ))}
            </div>
          </div>
