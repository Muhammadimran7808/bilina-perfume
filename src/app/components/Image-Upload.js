...
export default function ImageUpload({ setFormData }) {
  ...
  return (
    <div>
      <label
        htmlFor="uploadFile1"
        className="bg-transparent text-[#666] font-semibold text-base max-w-md h-52 flex flex-col items-center justify-center cursor-pointer border-2 border-[#2a2a2a] border-dashed mx-auto"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-11 mb-2 fill-[#666]"
          viewBox="0 0 32 32"
        >
          <path
        ...
        />
        <p className="text-xs font-medium text-[#888] mt-2">
